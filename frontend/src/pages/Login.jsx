      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="glass border border-green-500/30 rounded-2xl p-8 shadow-2xl backdrop-blur-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-400 mb-2">Welcome Back</h1>
            <p className="text-gray-400 text-sm">Sign in to continue to CodeX Studio</p>
          </div>
          ...
          <form onSubmit={submitForm} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center cursor-pointer">
                ...
                <span className="ml-2 text-gray-400 text-sm hover:text-gray-300 transition-colors">Remember me</span>
              </label>
              <Link to="#" className="text-green-400 hover:text-green-300 text-sm transition-colors duration-200 font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-black text-gray-400 text-xs">New to CodeX?</span>
            </div>
          </div>
          ...
          <Link
            to="/signUp"
            className="w-full py-3 border border-green-500/50 text-green-400 hover:bg-green-500/10 text-center block mt-3 rounded-lg font-semibold transition-all duration-200"
          >
            Create Account
          </Link>
        </div>
